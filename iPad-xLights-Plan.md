...
| C | Effect settings inspector | In progress — C4 multi-effect landed; Sketch + Morph editors landed; G3 (Moving Head) and G8 (DMX) still open | [`plans/phase-c-inspector.md`](plans/phase-c-inspector.md) |
