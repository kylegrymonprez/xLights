...
| C | Effect settings inspector | In progress — C4 multi-effect landed (N-selected chrome, Apply to All, Update All); C7 specialised editors still open | [`plans/phase-c-inspector.md`](plans/phase-c-inspector.md) |
