...
| C | Effect settings inspector | ✓ complete — DMX state persistence (G8+) landed 2026-04-28: `iPadRenderContext::SaveModelStates` mirrors `SaveViewpoints`, dmxSaveState marks the model dirty + persists immediately to xlights_rgbeffects.xml. MH colour/path authoring still tracked in [`plans/followups.md`](plans/followups.md) | — |
