...
| E | Sequence management (open / save / new / settings) | ✓ complete — E-1 through E-6 shipped 2026-04-21; `.fseq` save+load short-circuit landed 2026-04-27 (toggle + folder picker in FolderConfig, v2/zstd/sparse write matching desktop, on-open render skip when a fresh fseq exists). Deferred tabs (Timings import/export, Audio Tracks, Data Layers) tracked in [`plans/followups.md`](plans/followups.md) | — |
