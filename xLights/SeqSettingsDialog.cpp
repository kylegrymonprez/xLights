...
const wxWindowID SeqSettingsDialog::ID_LISTBOX_AlternateMedia = wxNewId();
    ...
    wizard_active(wizard_active_)
{
    ...
    FlexGridSizer_AltMediaListContainer = new wxFlexGridSizer(1, 1, 0, 0);
    FlexGridSizer_AltMediaListContainer->AddGrowableCol(0);
    FlexGridSizer_AltMediaListContainer->AddGrowableRow(0);
    ListBox_AlternateMedia = new wxListBox(Panel_AlternateMedia, ID_LISTBOX_AlternateMedia, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LISTBOX_AlternateMedia"));
    FlexGridSizer_AltMediaListContainer->Add(ListBox_AlternateMedia, 1, wxALL|wxEXPAND, 5);
